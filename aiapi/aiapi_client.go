...
type ClientService interface {
	...
	PostPartnersOrganizationsIDSearch(params *PostPartnersOrganizationsIDSearchParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PostPartnersOrganizationsIDSearchOK, error)
...
/*
PostPartnersOrganizationsIDSearch posts search

Post search
*/
func (a *Client) PostPartnersOrganizationsIDSearch(params *PostPartnersOrganizationsIDSearchParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PostPartnersOrganizationsIDSearchOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewPostPartnersOrganizationsIDSearchParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "PostPartnersOrganizationsIDSearch",
		Method:             "POST",
		PathPattern:        "/partners/organizations/{id}/search",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &PostPartnersOrganizationsIDSearchReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*PostPartnersOrganizationsIDSearchOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PostPartnersOrganizationsIDSearch: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
